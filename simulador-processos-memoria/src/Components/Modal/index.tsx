        ...
        <Container>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <label>
              ...
              <input {...register('arrival')} inputMode="numeric" defaultValue={0} />
            </label>
            <label>
              <span>Tempo de execução</span>
              <input {...register('burst')} defaultValue={4} />
            </label>
            <label>
              <span>Deadline</span>
              <input {...register('deadline')} defaultValue={2}/>
            </label>
            <label>
              <span>Prioridade</span>
              <input {...register('priority')} defaultValue={1}/>
            </label>
            <label>
              <span>Número de Páginas</span>
              <input {...register('pages')} defaultValue={1} inputMode="numeric" />
            </label>
